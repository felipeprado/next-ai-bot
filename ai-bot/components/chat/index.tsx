...
const backdrop = tv({
  base: "fixed z-[60] top-0 left-0 w-full h-full backdrop-blur-md select-none pointer-events-none duration-300 md:hidden",
  variants: {
    setStatus: {
      closed: "select-none pointer-events-none opacity-0",
      opened: "opacity-1",
    },
  },
});
...
const Chat = ({
  ...
  return (
    <>
      ...
      {/* backdrop */}
      {variant === "float" && <div className={backdrop({ setStatus })} />}
    </>
  );
};
